...
bool CCrossHair::Init(void)
{
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Image/GUI/CameraEffects_CrossHair1.tga", true);
	if (iTextureID == 0)
	{
		cout << "Unable to load Image/GUI/CameraEffects_CrossHair1.tga" << endl;
		return false;
	}
