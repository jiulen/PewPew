...
public:
    ...
    int GetCurrentTextureIndex(void) const;
    // Set current texture index
    void SetCurrentTextureIndex(const int m_iNewTextureIndex);
...
protected:
    ...
    std::vector<GLuint> arrTextureID;

    // The current texture ID being rendered
    int m_iCurrentTextureIndex;
