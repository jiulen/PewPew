...
bool CSkyBox::Init(void)
{
	...
	arrTextureID.push_back(LoadSkyBoxTextures());
	// Clear the vector of image file names
	skyboxTexture.clear();

	// Create the vector of skybox textures
	skyboxTexture.push_back("Image/SkyBox/skybox1_right.jpg");
	skyboxTexture.push_back("Image/SkyBox/skybox1_left.jpg");
	skyboxTexture.push_back("Image/SkyBox/skybox1_top.jpg");
	skyboxTexture.push_back("Image/SkyBox/skybox1_bottom.jpg");
	skyboxTexture.push_back("Image/SkyBox/skybox1_front.jpg");
	skyboxTexture.push_back("Image/SkyBox/skybox1_back.jpg");
	...
	// Create the vector of skybox textures
	skyboxTexture.push_back("Image/SkyBox/skybox2_right.jpg");
	skyboxTexture.push_back("Image/SkyBox/skybox2_left.jpg");
	skyboxTexture.push_back("Image/SkyBox/skybox2_top.jpg");
	skyboxTexture.push_back("Image/SkyBox/skybox2_bottom.jpg");
	skyboxTexture.push_back("Image/SkyBox/skybox2_front.jpg");
	skyboxTexture.push_back("Image/SkyBox/skybox2_back.jpg");
...
{
	//sview = glm::rotate(glm::mat4(view), rotation, glm::vec3(0, 1, 0)); // rotate skybox
	...
	glBindTexture(GL_TEXTURE_CUBE_MAP, arrTextureID[m_iCurrentTextureIndex]);
	glBindVertexArray(VAO);
...
int CSkyBox::GetCurrentTextureIndex(void) const
{
	return m_iCurrentTextureIndex;
}

// Set current texture Index
void CSkyBox::SetCurrentTextureIndex(const int m_iNewTextureIndex)
{
	if ((m_iNewTextureIndex < 0) || (m_iNewTextureIndex > 2))
		return;

	m_iCurrentTextureIndex = m_iNewTextureIndex;
}
