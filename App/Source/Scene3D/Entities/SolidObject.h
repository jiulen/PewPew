...
public:
	...
	int fear; //for enemy -> 0 - no fear, 1 - normal fear, 2 - big fear

	bool hurt; //for enemy

	//for minimap icon rendering

	GLuint VAO_ICON, VBO_ICON, IBO_ICON;

	GLuint iTextureID_Icon; //if -1 means no icon
