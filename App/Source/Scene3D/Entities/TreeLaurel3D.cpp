 ...
 */
CTreeLaurel3D::CTreeLaurel3D(void)
 ...
 */
CTreeLaurel3D::CTreeLaurel3D(	const glm::vec3 vec3Position,
...
bool CTreeLaurel3D::Init(void)
{
	...
	std::string file_path = "Models/TreeLaurel/LaurelTree.obj";
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Models/TreeLaurel/LaurelTree.tga", false);
	if (iTextureID == 0)
	{
		cout << "Unable to load Models/TreeLaurel/LaurelTree.tga" << endl;
		return false;
	}
	...
	if (bInstancedRendering)
	{
		...
		srand((unsigned int)glfwGetTime() + 2);
 ...
 */
void CTreeLaurel3D::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CTreeLaurel3D::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CTreeLaurel3D::SetProjection(const glm::mat4 projection)
{
...
*/
void CTreeLaurel3D::SetInstancingMode(const bool bInstancedRendering)
{
 ...
 */
void CTreeLaurel3D::SetNumOfInstance(const unsigned int iNumOfInstance)
{
 ...
 */
void CTreeLaurel3D::SetSpreadDistance(const float fSpreadDistance)
{
 ...
 */
bool CTreeLaurel3D::Update(const double dElapsedTime)
{
	if (!bInstancedRendering)
	{
...
*/
void CTreeLaurel3D::PreRender(void)
{
...
*/
void CTreeLaurel3D::Render(void)
{
	if (bInstancedRendering)
	{
...
*/
void CTreeLaurel3D::PostRender(void)
{
...
/**
 @brief Print Self
 */
void CTreeLaurel3D::PrintSelf(void)
{
	cout << "CTreeLaurel3D::PrintSelf()" << endl;
	cout << "========================" << endl;
}
