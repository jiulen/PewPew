 ...
 */
CTreeSpruce3D::CTreeSpruce3D(void)
 ...
 */
CTreeSpruce3D::CTreeSpruce3D(	const glm::vec3 vec3Position,
...
bool CTreeSpruce3D::Init(void)
{
	...
	std::string file_path = "Models/TreeSpruce/SpruceTree.obj";
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Models/TreeSpruce/SpruceTree.tga", false);
	if (iTextureID == 0)
	{
		cout << "Unable to load Models/TreeSpruce/SpruceTree.tga" << endl;
		return false;
	}
	...
	if (bInstancedRendering)
	{
		...
		srand((unsigned int)glfwGetTime() + 4);
 ...
 */
void CTreeSpruce3D::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CTreeSpruce3D::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CTreeSpruce3D::SetProjection(const glm::mat4 projection)
{
...
*/
void CTreeSpruce3D::SetInstancingMode(const bool bInstancedRendering)
{
 ...
 */
void CTreeSpruce3D::SetNumOfInstance(const unsigned int iNumOfInstance)
{
 ...
 */
void CTreeSpruce3D::SetSpreadDistance(const float fSpreadDistance)
{
 ...
 */
bool CTreeSpruce3D::Update(const double dElapsedTime)
{
	if (!bInstancedRendering)
	{
...
*/
void CTreeSpruce3D::PreRender(void)
{
...
*/
void CTreeSpruce3D::Render(void)
{
	if (bInstancedRendering)
	{
...
*/
void CTreeSpruce3D::PostRender(void)
{
...
/**
 @brief Print Self
 */
void CTreeSpruce3D::PrintSelf(void)
{
	cout << "CTreeSpruce3D::PrintSelf()" << endl;
	cout << "========================" << endl;
}
