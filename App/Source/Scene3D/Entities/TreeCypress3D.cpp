 ...
 */
CTreeCypress3D::CTreeCypress3D(void)
 ...
 */
CTreeCypress3D::CTreeCypress3D(	const glm::vec3 vec3Position,
...
bool CTreeCypress3D::Init(void)
{
	...
	std::string file_path = "Models/TreeCypress/CypressTree.obj";
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Models/TreeCypress/CypressTree.tga", false);
	if (iTextureID == 0)
	{
		cout << "Unable to load Models/TreeCypress/CypressTree.tga" << endl;
		return false;
	}
 ...
 */
void CTreeCypress3D::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CTreeCypress3D::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CTreeCypress3D::SetProjection(const glm::mat4 projection)
{
...
*/
void CTreeCypress3D::SetInstancingMode(const bool bInstancedRendering)
{
 ...
 */
void CTreeCypress3D::SetNumOfInstance(const unsigned int iNumOfInstance)
{
 ...
 */
void CTreeCypress3D::SetSpreadDistance(const float fSpreadDistance)
{
 ...
 */
bool CTreeCypress3D::Update(const double dElapsedTime)
{
	if (!bInstancedRendering)
	{
...
*/
void CTreeCypress3D::PreRender(void)
{
...
*/
void CTreeCypress3D::Render(void)
{
	if (bInstancedRendering)
	{
...
*/
void CTreeCypress3D::PostRender(void)
{
...
/**
 @brief Print Self
 */
void CTreeCypress3D::PrintSelf(void)
{
	cout << "CTreeCypress3D::PrintSelf()" << endl;
	cout << "========================" << endl;
}
