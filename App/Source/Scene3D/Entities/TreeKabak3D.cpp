...
bool CTreeKabak3D::Init(void)
{
	...
	std::string file_path = "Models/Tree_Kabak/tree.obj";
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Models/Tree_Kabak/tree.tga", false);
	if (iTextureID == 0)
	{
		cout << "Unable to load Models/Tree_Kabak/Kabak_Bark_and_Leaves_v1_S.png" << endl;
		return false;
	}
