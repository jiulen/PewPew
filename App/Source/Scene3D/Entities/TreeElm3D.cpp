 ...
 */
CTreeElm3D::CTreeElm3D(	const glm::vec3 vec3Position,
...
bool CTreeElm3D::Init(void)
{
	...
	std::string file_path = "Models/TreeElm/ElmTree.obj";
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Models/TreeElm/ElmTree.tga", false);
	if (iTextureID == 0)
	{
		cout << "Unable to load Models/TreeElm/ElmTree.tga" << endl;
		return false;
	}
	...
	if (bInstancedRendering)
	{
		...
		srand((unsigned int)glfwGetTime() + 1);
 ...
 */
void CTreeElm3D::SetModel(const glm::mat4 model)
{
	this->model = model;
}
 ...
 */
void CTreeElm3D::SetView(const glm::mat4 view)
{
	this->view = view;
}
 ...
 */
void CTreeElm3D::SetProjection(const glm::mat4 projection)
{
...
*/
void CTreeElm3D::SetInstancingMode(const bool bInstancedRendering)
{
 ...
 */
void CTreeElm3D::SetNumOfInstance(const unsigned int iNumOfInstance)
{
 ...
 */
void CTreeElm3D::SetSpreadDistance(const float fSpreadDistance)
{
 ...
 */
bool CTreeElm3D::Update(const double dElapsedTime)
{
	if (!bInstancedRendering)
	{
...
*/
void CTreeElm3D::PreRender(void)
{
...
*/
void CTreeElm3D::PostRender(void)
{
...
/**
 @brief Print Self
 */
void CTreeElm3D::PrintSelf(void)
{
	cout << "CTreeElm3D::PrintSelf()" << endl;
	cout << "========================" << endl;
}
