...
public:
	...
	bool automatic;
	bool canScope;
	float passiveSpeedMultiplier; //affects player movement speed - when not equipped
	float activeSpeedMultiplier; //affects player movement speed - when equipped
	int shootSoundID;
	int reloadSoundID;
	enum CROSSHAIR
	{
	...
	float weaponRotation; // reload
	float reloadAnimTimeMax;
