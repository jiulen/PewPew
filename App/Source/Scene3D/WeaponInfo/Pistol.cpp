...
bool CPistol::Init(void)
{
	...
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Models/Pistol/map_gunType64_01.tga", false);
	if (iTextureID == 0)
	{
		cout << "Unable to load Models/Pistol/map_gunType64_01.tga" << endl;
		return false;
	}
