...
class CSceneNode : public CLevelOfDetails, public CSolidObject
{
public:
	// Constructor
	CSceneNode(void);
	...
	bool InitModels(const char* filenameModel, const char* filenameTexture);
	bool InitModels(const char* filenameModelH, const char* filenameTextureH, 
	...
	enum SG_Type //only for scene graph with changing transformation
	{
		DROP_RIDE,
		CAROUSEL,
		BOUNCY,
